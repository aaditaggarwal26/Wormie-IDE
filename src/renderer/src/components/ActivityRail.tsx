import { BookOpenText, Braces, ClipboardCheck, FolderTree, GitBranch, GraduationCap, Search, Settings2 } from 'lucide-react'
import { useWorkbench } from '@/store/workbench'

const activities = [
  { id: 'explorer' as const, label: 'Explorer', icon: FolderTree },
  { id: 'search' as const, label: 'Search', icon: Search },
  { id: 'outline' as const, label: 'Outline', icon: Braces },
