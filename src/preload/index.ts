...
const desktopApi: DesktopApi = {
  ...
  getMasteryDomains: () => ipcRenderer.invoke(IPC_CHANNELS.masteryDomains),
  getMasteryConcept: (conceptId) => ipcRenderer.invoke(IPC_CHANNELS.masteryConcept, conceptId),
  getMasteryEvidence: (request) => ipcRenderer.invoke(IPC_CHANNELS.masteryEvidence, request),
  getMasteryMisconceptions: (status) => ipcRenderer.invoke(IPC_CHANNELS.masteryMisconceptions, status),
  getMasteryReviews: () => ipcRenderer.invoke(IPC_CHANNELS.masteryReviews),
  startMasteryReview: (conceptId) => ipcRenderer.invoke(IPC_CHANNELS.masteryStartReview, conceptId),
  submitMasteryReview: (submission) => ipcRenderer.invoke(IPC_CHANNELS.masterySubmitReview, submission),
  getLearningPersonalization: () => ipcRenderer.invoke(IPC_CHANNELS.masteryGetPersonalization),
  saveLearningPersonalization: (update) => ipcRenderer.invoke(IPC_CHANNELS.masterySavePersonalization, update),
  resetLearningPersonalization: () => ipcRenderer.invoke(IPC_CHANNELS.masteryResetPersonalization),
  getLearningGoals: () => ipcRenderer.invoke(IPC_CHANNELS.masteryGetGoals),
  createLearningGoal: (input) => ipcRenderer.invoke(IPC_CHANNELS.masteryCreateGoal, input),
  updateLearningGoal: (id, update) => ipcRenderer.invoke(IPC_CHANNELS.masteryUpdateGoal, { id, update }),
  deleteLearningGoal: (id) => ipcRenderer.invoke(IPC_CHANNELS.masteryDeleteGoal, id),
  getLearningGamification: () => ipcRenderer.invoke(IPC_CHANNELS.masteryGamification),
  getMasterySyncStatus: () => ipcRenderer.invoke(IPC_CHANNELS.masterySyncStatus),
  ...
  removeClassroomStudent: (classroomId, userId) => ipcRenderer.invoke(IPC_CHANNELS.cloudRemoveStudent, classroomId, userId),
  leaveClassroom: (classroomId) => ipcRenderer.invoke(IPC_CHANNELS.cloudLeaveClassroom, classroomId),
  beginClassroomAssignmentAuthoring: (classroomId) => ipcRenderer.invoke(IPC_CHANNELS.cloudBeginAssignmentAuthoring, classroomId),
  listClassroomMastery: (classroomId) => ipcRenderer.invoke(IPC_CHANNELS.cloudListClassroomMastery, classroomId),
  listClassroomAiAnalytics: (classroomId) => ipcRenderer.invoke(IPC_CHANNELS.cloudListClassroomAiAnalytics, classroomId),
  listClassroomAssignmentProgress: (classroomId) => ipcRenderer.invoke(IPC_CHANNELS.cloudListAssignmentProgress, classroomId),
  openClassroomAssignmentSubmission: (assignmentId, studentId) => ipcRenderer.invoke(IPC_CHANNELS.cloudOpenAssignmentSubmission, assignmentId, studentId),
